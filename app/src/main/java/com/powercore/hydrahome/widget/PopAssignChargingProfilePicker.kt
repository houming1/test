...
class PopAssignChargingProfilePicker(context: Context) : CenterPopupView(context) {
    private lateinit var bind: PopAssignChargingProfilePickerBinding
    private var mOkBlock: (String) -> Unit = {}
    var hydraHomeHouseholdProfilePk = ""
    override fun getImplLayoutId(): Int {
        return R.layout.pop_assign_charging_profile_picker
    }
