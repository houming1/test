...
import com.powercore.hydrahome.app.App

class SuddleBarChartRenderer(chart: BarDataProvider?, animator: ChartAnimator?, viewPortHandler: ViewPortHandler?) : BarChartRenderer(chart, animator, viewPortHandler) {
    ...
    override fun drawDataSet(c: Canvas, dataSet: IBarDataSet, index: Int) {
        ...
        if (mChart.isDrawBarShadowEnabled) {
            mShadowPaint.color = App.appContext.resources.getColor(R.color.color_EEF0FA)
...
//                Path.Direction.CCW
//            )
            c.drawRoundRect(mBarRect,50.toFloat(),50.toFloat(),mHighlightPaint)
