...
import com.powercore.hydrahome.utils.DateUtil.dateUTCToString
import com.powercore.hydrahome.utils.DateUtil.formatTimeStamp
import com.powercore.hydrahome.utils.DateUtil.toDayFrendly2
import java.util.*
...
//        }
        ...
        val remainingTime =
            if (up)
                Date().time - formatTimeStamp(time.toString().dateUTCToString()) + 1000
            else
                formatTimeStamp(time.toString().dateUTCToString()) - Date().time + 1000
        ...
        try {
            if (remainingTime <= 0){
                ...
                val second: Int = ((remainingTime - 1000 * hour * 3600 - minute * 60 * 1000) / 1000).toInt()
