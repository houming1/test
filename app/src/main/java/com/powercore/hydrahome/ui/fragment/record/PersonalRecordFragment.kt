...
import com.powercore.hydrahome.databinding.FragmentRecordPersonalBinding
...
class PersonalRecordFragment :
    BaseDbVmFragment<FragmentRecordPersonalBinding, PersonalRecordViewModel>() {
