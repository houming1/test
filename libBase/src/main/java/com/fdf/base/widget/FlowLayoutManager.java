...
public class FlowLayoutManager extends RecyclerView.LayoutManager {
    ...
    private void fillLayout(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        Rect displayFrame = new Rect(getPaddingStart(), getPaddingTop() + verticalScrollOffset,
                getWidth() - getPaddingEnd(), verticalScrollOffset + (getHeight() - getPaddingBottom()));
    ...
    public int getHorizontalSpace() {
        return self.getWidth() - self.getPaddingStart() - self.getPaddingEnd();
    }
