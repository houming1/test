...
@TargetApi(30)
class CustomDialogFragment constructor(
    private var mMessage: String,
    private var mPermissions: List<String>
) :
...
//        Manifest.permission.ACCESS_BACKGROUND_LOCATION to Manifest.permission_group.LOCATION,
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        val lp=_binding?.root?.layoutParams
        lp?.width=ScreenUtils.getScreenSize(context)[0]/3*2
        return binding.root
    }
